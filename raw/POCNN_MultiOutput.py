        ...
        for i, data in enumerate(valloader, 0):
            with torch.no_grad():
                ...
                if i == int(10000/batch_size):
                    break                
        val_loss_epoch = val_running_loss / ( int(10000/batch_size) * batch_size ) 
...
result = tune.run(
            ...
            name="pocnn_multi_output_freezing_pretrained_5outputs",
            scheduler= scheduler,
...
auc_average, auc_quantile = test_accuracy_mo(best_trained_model, device)


'''
>>> best_checkpoint_dir
'/home/pablo/ray_results/pocnn_multi_output_freezing_pretrained_T_5outputs/DEFAULT_42d63_00002_2_lr=6.6044e-06_2022-02-02_02-02-58/checkpoint_29/'
'''
model_state, optimizer_state = torch.load(os.path.join(best_checkpoint_dir, "checkpoint"))  
...
>>> best_checkpoint_dir = best_trial.checkpoint.value
>>> best_checkpoint_dir
'/home/pablo/ray_results/pocnn_multi_output_freezing/DEFAULT_c1e30_00001_1_lr=5.5714e-06_2022-01-31_02-16-00/checkpoint_29/'
