...
class Resnet18_mo(nn.Module):
    def __init__(self, use_pretrained):
        ...
        self.fc1 = nn.Linear(num_ftrs  + 15, 1)
        self.fc2 = nn.Linear(num_ftrs  + 15, 1)
        self.fc3 = nn.Linear(num_ftrs + 15, 1)
        self.fc4 = nn.Linear(num_ftrs + 15, 1)
        self.fc5 = nn.Linear(num_ftrs + 15, 1)        
    ...
    def forward(self, image,clin_covariates ):
        ...
        x2 = torch.tanh(self.fc2(x))
        x3 = torch.tanh(self.fc3(x))
        x4 = torch.tanh(self.fc4(x))
        x5 = torch.tanh(self.fc5(x))
...
result = tune.run(
            ...
            name="ipcwpocnn_multi_output_freezing_pretrained_T_5outputs",
            scheduler= scheduler,
