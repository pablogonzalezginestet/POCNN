...
def main():
    ...
    #auc2
    auc2_json_path = os.path.join(model_dir,"auc2_po_so")
    np.save(auc2_json_path,AUC2_matrix)
    #auc3
    auc3_json_path = os.path.join(model_dir,"auc3_po_so")
    np.save(auc3_json_path,AUC3_matrix)
    #auc4
    auc4_json_path = os.path.join(model_dir,"auc4_po_so")
    np.save(auc4_json_path,AUC4_matrix)
    #auc5
    auc5_json_path = os.path.join(model_dir,"auc5_po_so")
    np.save(auc5_json_path,AUC5_matrix)
    #training loss
    train_loss_path = os.path.join(model_dir,"train_loss_po_so")
    np.save(train_loss_path,train_loss_matrix)
    #val loss
    val_loss_path = os.path.join(model_dir,"val_loss_po_so")
